...
export const Sobre = () => {
	...
	const handleCompra = () => {
			...
			const mensagem = `Olá, tudo bem? Estou interessado(a) em um dos seus produtos da loja Ichiban. Poderia me ajudar com mais informações, por favor?`;
        ...
        <div className={styles["container"]}>
            <div className={styles["texto"]}>
                ...
                <div className={styles['contato-div']}>
                    <button onClick={handleCompra} className={styles['contato-btn']}>Entre em contato conosco</button><img className={styles['img-whats']} alt="Imagem Whatsapp" src={imgWhats} />
                </div>
            </div>
